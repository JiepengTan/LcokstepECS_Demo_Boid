...
namespace Lockstep.UnsafeECS.Game {  
    ...
    public static unsafe class EntityViewUtil {
        ...
        public static FuncOnBindView[] _lutFuncOnBindView = new FuncOnBindView[] {
            ...
            null,
            null,
            _OnBindEntityViewBoidTarget,
            _OnBindEntityViewBoidObstacle,        
        };
        static BaseEntityView _OnBindEntityViewBoidTarget(Entity* ptr){
#if DEBUG
            var go = new GameObject(ptr->_localId + "BoidTarget");  
#else
            var go = new GameObject();   
#endif 
            var comp = go.AddComponent<EntityViewBoidTarget>();
            return comp;
        }
        static BaseEntityView _OnBindEntityViewBoidObstacle(Entity* ptr){
#if DEBUG
            var go = new GameObject(ptr->_localId + "BoidObstacle");  
#else
            var go = new GameObject();   
#endif 
            var comp = go.AddComponent<EntityViewBoidObstacle>();
            return comp;
        }    
    }
    ...
    public unsafe partial class EntityViewBoidTarget :BaseEntityView {
        public static EntityViewBoidTarget Instance=>_Instance;
        private static EntityViewBoidTarget _Instance;
        [SerializeField] public BoidTarget _cloneEntity;
    ...
    public unsafe partial class EntityViewBoidObstacle :BaseEntityView {
        public static EntityViewBoidObstacle Instance=>_Instance;
        private static EntityViewBoidObstacle _Instance;
        [SerializeField] public BoidObstacle _cloneEntity;
