...
namespace Lockstep.UnsafeECS.Game {                                                              
   ...
   public static unsafe class PointerExt {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Item* ToItemPtr(this long val){
            #if DEBUG
            if ((val == 0L || ((Item*) val)->EntityType != EEntityType.Item)) {
                throw new Exception("ToItemPtr error: diff type " + val);
            }
            #endif
            return (Item*) val;
        }
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Camp* ToCampPtr(this long val){
            #if DEBUG
            if ((val == 0L || ((Camp*) val)->EntityType != EEntityType.Camp)) {
                throw new Exception("ToCampPtr error: diff type " + val);
            }
            #endif
            return (Camp*) val;
        }
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Player* ToPlayerPtr(this long val){
            #if DEBUG
            if ((val == 0L || ((Player*) val)->EntityType != EEntityType.Player)) {
                throw new Exception("ToPlayerPtr error: diff type " + val);
            }
            #endif
            return (Player*) val;
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Spawner* ToSpawnerPtr(this long val){
            #if DEBUG
            if ((val == 0L || ((Spawner*) val)->EntityType != EEntityType.Spawner)) {
                throw new Exception("ToSpawnerPtr error: diff type " + val);
            }
            #endif
            return (Spawner*) val;
        }
    ...
    [StructLayoutAttribute(LayoutKind.Sequential, Pack = Define.PackSize)]
    public unsafe partial struct ItemIterator : IEnumerator<long>, IEnumerable<long> {
        private Int32 _index;
        private Item* _ptr;
        private long _current;
        private int _count;
    ...
    [StructLayoutAttribute(LayoutKind.Sequential, Pack = Define.PackSize)]
    public unsafe partial struct CampIterator : IEnumerator<long>, IEnumerable<long> {
        private Int32 _index;
        private Camp* _ptr;
        private long _current;
        private int _count;
        ...
        public CampIterator(Camp* ptr,int count){
            _ptr = ptr;
            _index = -1;
            _current = 0;
            _count = count;
    ...
    [StructLayoutAttribute(LayoutKind.Sequential, Pack = Define.PackSize)]
    public unsafe partial struct PlayerIterator : IEnumerator<long>, IEnumerable<long> {
        private Int32 _index;
        private Player* _ptr;
        private long _current;
        private int _count;
        ...
        public PlayerIterator(Player* ptr,int count){
            _ptr = ptr;
            _index = -1;
            _current = 0;
            _count = count;
    ...
    [StructLayoutAttribute(LayoutKind.Sequential, Pack = Define.PackSize)]
    public unsafe partial struct SpawnerIterator : IEnumerator<long>, IEnumerable<long> {
        private Int32 _index;
        private Spawner* _ptr;
        private long _current;
        private int _count;
        public long Current => _current;
        object IEnumerator.Current {
        ...
        public SpawnerIterator(Spawner* ptr,int count){
            _ptr = ptr;
            _index = -1;
            _current = 0;
            _count = count;
