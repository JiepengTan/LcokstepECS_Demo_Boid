...
namespace Lockstep.UnsafeECS.Game {
    ...
    public abstract unsafe partial class BaseUnityEntityService : BaseService,IEntityService {
        ...
        public virtual void OnBoidSpawnerCreated(Context context, BoidSpawner* entity){}
        public virtual void OnBoidSpawnerDestroy(Context context, BoidSpawner* entity){}
        public virtual void OnBoidCellCreated(Context context, BoidCell* entity){}
        public virtual void OnBoidCellDestroy(Context context, BoidCell* entity){}
        public virtual void OnBoidCreated(Context context, Boid* entity){}
        public virtual void OnBoidDestroy(Context context, Boid* entity){}
        public virtual void OnBoidTargetCreated(Context context, BoidTarget* entity){}
        public virtual void OnBoidTargetDestroy(Context context, BoidTarget* entity){}
        public virtual void OnBoidObstacleCreated(Context context, BoidObstacle* entity){}
        public virtual void OnBoidObstacleDestroy(Context context, BoidObstacle* entity){} 
    }
}                                                                                
